...
SilverSwordWeaponConfig.HumanoidToKill = ("Humanoid")
	SilverSwordWeaponConfig.WalkSpeed = 14
	SilverSwordWeaponConfig.JumpHeight = 10
	SilverSwordWeaponConfig.MaxDamage = 7 * mult
	SilverSwordWeaponConfig.MinDamage = 5 * mult
